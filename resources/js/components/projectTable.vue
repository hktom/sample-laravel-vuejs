<template>
    <div>
        ...
        </span>    Les actions du CA4 en un coup d’œil
        </h3>

        <h6>Les actions sur fond coloré sont prioritaires.</h6>
        ...
        <b-row>
            <b-col lg="12">
                ...
                >
                    <p class="table-row">{{ item.id }} {{ item.label }}</p>
                </div>
            </b-col>
            ...
            <b-col lg="12">
                ...
                :style="'background-color:' + color"
                class="my-4 action-title cursor-pointer">
                Poursuivre & renforcer les actions existantes</h5>
                <div
                    v-if="actionShow"
